...
public class CameraHandler implements View.OnClickListener {
    ...
    private void pickPhtot(){
        ...
        DELEGAT.startActivityForResult(Intent.createChooser(intent,"选择获取的图片方式"),RequestCodes.PICK_PHOTO);
    }
    // 拍照
    private void takePhoto(){
        ...
        DELEGAT.startActivityForResult(intent,RequestCodes.TAKE_PHOTO);
    }
}
